...
##
## This script allows you to add a backup seed to a system that does not currently have one, or to change the backup seed to a new one, if the need arises
##
## Once this script executes and is processed by the system, call "cleanupBackupSecret.sh" to remove the backup secret from active use.
##
## The backup seed file produced by this script needs to be securely stored. After this operation and old backup seed
## that was configured is no longer useful.
##
